...
class MassTransferTransactionData extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type array<\wavesplatform\Protobuf\MassTransferTransactionData\Transfer>|\Google\Protobuf\Internal\RepeatedField $transfers
    ...
    /**
     * Generated from protobuf field <code>repeated .waves.MassTransferTransactionData.Transfer transfers = 2;</code>
     * @param array<\wavesplatform\Protobuf\MassTransferTransactionData\Transfer>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setTransfers($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \wavesplatform\Protobuf\MassTransferTransactionData\Transfer::class);
        $this->transfers = $arr;
