...
class SignedTransaction extends \Google\Protobuf\Internal\Message
{
     ...
     *
     *     @type \wavesplatform\Protobuf\Transaction $waves_transaction
     ...
     * @return \wavesplatform\Protobuf\Transaction|null
     */
    ...
    /**
     * Generated from protobuf field <code>.waves.Transaction waves_transaction = 1;</code>
     * @param \wavesplatform\Protobuf\Transaction $var
     * @return $this
     */
    public function setWavesTransaction($var)
    {
        GPBUtil::checkMessage($var, \wavesplatform\Protobuf\Transaction::class);
