...
class Order extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type \wavesplatform\Protobuf\AssetPair $asset_pair
     *     @type int $order_side
     *     @type int|string $amount
     *     @type int|string $price
     *     @type int|string $timestamp
     *     @type int|string $expiration
     *     @type \wavesplatform\Protobuf\Amount $matcher_fee
     *     @type int $version
    ...
    public function __construct($data = NULL) {
        \wavesplatform\ProtobufMetadata\Order::initOnce();
    ...
    /**
     * Generated from protobuf field <code>.waves.AssetPair asset_pair = 4;</code>
     * @return \wavesplatform\Protobuf\AssetPair|null
     */
    ...
    /**
     * Generated from protobuf field <code>.waves.AssetPair asset_pair = 4;</code>
     * @param \wavesplatform\Protobuf\AssetPair $var
     * @return $this
     */
    public function setAssetPair($var)
    {
        GPBUtil::checkMessage($var, \wavesplatform\Protobuf\AssetPair::class);
        $this->asset_pair = $var;
    ...
    {
        GPBUtil::checkEnum($var, \wavesplatform\Protobuf\Order\Side::class);
        $this->order_side = $var;
    ...
    {
        GPBUtil::checkEnum($var, \wavesplatform\Protobuf\Order\PriceMode::class);
        $this->price_mode = $var;
