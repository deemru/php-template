...
class ExchangeTransactionData extends \Google\Protobuf\Internal\Message
{
     ...
     *     @type array<\wavesplatform\Protobuf\Order>|\Google\Protobuf\Internal\RepeatedField $orders
     * }
     */
    ...
    /**
     * Generated from protobuf field <code>repeated .waves.Order orders = 5;</code>
     * @param array<\wavesplatform\Protobuf\Order>|\Google\Protobuf\Internal\RepeatedField $var
     * @return $this
     */
    public function setOrders($var)
    {
        $arr = GPBUtil::checkRepeatedField($var, \Google\Protobuf\Internal\GPBType::MESSAGE, \wavesplatform\Protobuf\Order::class);
        $this->orders = $arr;
